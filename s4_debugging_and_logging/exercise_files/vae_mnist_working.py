...
# train_dataset = TensorDataset(train_dataset.data.view(-1, 784).float() / 255.0, train_dataset.targets)
# test_dataset = MNIST(dataset_path, transform=mnist_transform, train=False, download=True)
# test_dataset = TensorDataset(test_dataset.data.view(-1, 784).float() / 255.0, test_dataset.targets)
